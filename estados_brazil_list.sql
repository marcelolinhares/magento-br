-- Este código é para incluir a lista de estados do brasil pra dentro do magento
-- premissa: setar o locale para pt_br
-- creditos: http://www.magentocommerce.com/boards/viewthread/23119/

INSERT INTO `magento_directory_country_region` (`country_id`, `code`, `default_name`) VALUES 
    ('BR', 'AC', 'Acre');
INSERT INTO `magento_directory_country_region_name` (`locale`, `region_id`, `name`) VALUES
